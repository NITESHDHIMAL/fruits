                ...
                <div className="row g-5 align-items-center">
                    <div className="col-md-12 col-lg-7">
                        ...
                        <div className="position-relative mx-auto">
                            ...
                            <button type="submit" className="btn btn-primary border-2 border-secondary py-3 px-4 position-absolute rounded-pill text-white h-100"  >Submit Now</button>
                        </div>
                    </div>
                            ...
                            <ul className="nav nav-pills d-inline-flex text-center mb-5">
                                ...
                                <li className="nav-item">
                                    <a className="d-flex m-2 py-2 bg-light rounded-pill" data-bs-toggle="pill" href="#tab-4">
                                        <span className="text-dark" >Bread</span>
                                    </a>
                                </li>
                                <li className="nav-item">
                        ...
                        <div className="position-relative">
                            ...
                            <div className="d-flex align-items-center flex-nowrap">
                                <div className="bg-secondary rounded">
                                    <img src="img/testimonial-1.jpg" className="img-fluid rounded"  alt=""/>
                                </div>
